...
fun <T: Parent> fxid(id: String? = null) = object : ReadOnlyProperty<BaseFxView<*, *>, T> {
    override fun getValue(thisRef: BaseFxView<*, *>, property: KProperty<*>): T {
...
@FlowPreview
@ExperimentalCoroutinesApi
fun <T:Parent> fxml(name: String? = null) = object : ReadOnlyProperty<BaseFxView<*,*>, T> {
